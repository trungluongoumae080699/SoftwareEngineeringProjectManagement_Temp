...
/*                             BULK INSERT (CHUNKED)                           */
/* -------------------------------------------------------------------------- */
async function insertTripsChunk(trips) {
  ...
  `;
    ...
    for (const t of trips) {
        values.push(t.id, t.bike_id, t.customer_id, t.hub_id, t.trip_status, t.reservation_date, t.reservation_expiry, t.trip_start_date, t.trip_end_date, t.trip_end_long, t.trip_end_lat, t.trip_secret);
    }
