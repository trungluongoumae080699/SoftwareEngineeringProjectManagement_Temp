...
export async function generateCustomersJson() {
    ...
    await fs.writeFile(path.join(OUTPUT_DIR, "customers.json"), JSON.stringify(customers, null, 2));
    await fs.writeFile(path.join(OUTPUT_DIR, "customerIds.json"), JSON.stringify(customerIds, null, 2));
